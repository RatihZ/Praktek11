...
while ($row = mysqli_fetch_array($kasus)) {
	...
	$query = mysqli_query($koneksi, "SELECT sum(New_Deaths) as New_Deaths FROM tb_covid where id='". $row['id']."'");
	$row = $query->fetch_array();
	$total_kematian[] = $row['New_Deaths'];
...
<html>
<head>
	<title> Chart Total Kematian </title>
